...
import { Brain, MessageSquare, LayoutDashboard, Code2, LogOut, Menu, X, Sparkles, Sun, Moon, Info, Bot, FolderOpen } from 'lucide-react';
...
export function Navigation() {
  ...
  const navItems = user ? [
    ...
    { label: 'Mes Projets', icon: FolderOpen, href: '/projects' },
  ] : [
